	...
	class PieReg_Base extends PieRegisterBaseVariables
	{
		...
		*/
		...
		function getDefaultMeta()
		{
			...
			if( !is_plugin_active("pie-register-field-visibility/pie-register-field-visibility.php") ){
...
// pie-register-woocommerce Addon
		...
		$structure["address"] .= '</div></div>';	
			...
			$structure["custom_role"] = apply_filters('pie_addon_field_visibility_settings', $structure["custom_role"]);
