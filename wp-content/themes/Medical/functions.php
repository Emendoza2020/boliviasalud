<?php
    ...
    function btheme_wp_enqueue_scripts(){
        wp_enqueue_style('bootstrap','https://stackpath.bootstrapcdn.com/bootstrap/4.2.1/css/bootstrap.min.css');
        //wp_enqueue_style('table','https://cdn.datatables.net/1.10.19/css/jquery.dataTables.min.css');
        //wp_enqueue_style('tabla','https://cdn.datatables.net/fixedheader/3.1.5/css/fixedHeader.dataTables.min.css');
        //wp_enqueue_style('table','/css/jquery.dataTables.min.css');
        //wp_enqueue_style('tabla','/css/fixedHeader.dataTables.min.css');
        wp_enqueue_script('ajax','https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js');
     
        //wp_enqueue_script('jquery','/js/jquery-3.3.1.js');
        //wp_enqueue_script('datatable','/js/jquery.dataTables.min.js');
        //wp_enqueue_script('datatabla','/js/dataTables.fixedHeader.min.js');

        //wp_enqueue_script('jquery','https://code.jquery.com/jquery-3.3.1.js');
        //wp_enqueue_script('datatable','https://cdn.datatables.net/1.10.19/js/jquery.dataTables.min.js');
        //wp_enqueue_script('datatabla','https://cdn.datatables.net/fixedheader/3.1.5/js/dataTables.fixedHeader.min.js');

    }
    add_action('wp_enqueue_scripts','btheme_wp_enqueue_scripts');
